...
fun createResolvedCallForHandleExceptionCall(
    ...
    val exceptionExpression = psiFactory.createExpression("exception")
    val continuationThisExpression = psiFactory.createExpression("this")

    val valueArguments = listOf(CallMaker.makeValueArgument(exceptionExpression), CallMaker.makeValueArgument(continuationThisExpression))
    ...
    return HandleResultCallContext(resolvedCall, exceptionExpression, continuationThisExpression)
}
